<template>
  <view class="page">
    <wd-tabs v-model="activeTab" @change="loadData"><wd-tab title="待接单" name="PENDING" /><wd-tab title="进行中" name="IN_PROGRESS" /><wd-tab title="已完成" name="COMPLETED" /></wd-tabs>
...
const activeTab = ref('PENDING'); const orders = ref<any[]>([]);
